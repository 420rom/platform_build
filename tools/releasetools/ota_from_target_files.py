...
""" % bcb_dev)
  ...
  script.Print("*******************************************************")
  script.Print("* 420rom 11.0 Pixel Edition - Android base 11.0.0 r37 *")
  script.Print("*******************************************************")
  ...
  script.Print("420rom version: {}".format(target_info.GetBuildProp("ro.420rom.version")))
  script.Print("Android version : {}".format(target_info.GetBuildProp("ro.build.version.release")))
  script.Print("Build type: {}".format(target_info.GetBuildProp("ro.420rom.releasetype")))
